...
conn <- dbConnect(SQLite(), 'https://drive.google.com/file/d/1TgJFYQVh1qMOQW8Z7jsQ9vlypaU83wuD/view?usp=sharing')
...
plot_usmap(data = fires_7, values = "total", "counties", include = c("CA"), labels = TRUE, size = 0.4) +
