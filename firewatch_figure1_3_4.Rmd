...
Preparing the Data 
------------------------------------------
```{r average wildfire count by Day of Year, fig.cap="Average Number of US Wildfires by Day of Year. Observe the trend of wildfires count over Time. Over past 27 years from 1992 to 2018, July is the month that wildfires occur more often than the other months. The reason is that this month is in summer, so high temperature together with the dry weather can easily ignite wildfires.",  out.width='98%', out.height='98%', echo=TRUE, warning=FALSE}
...
```{r Number of Wildfires by Size Class, fig.cap="Number of US Wildfires by Size Class per year. The human’s behavior has a large amount of impact on wildfire. ", out.width='99%', out.height='99%', echo=TRUE, warning=FALSE}
...
```{r Number of wildfires by cause, fig.cap="Number of US Wildfires by cause type. Human’s behaviors such as arson, recreation and ceremony, and debris and open burning have a lot of impact on wildfires, so human is the main cause of wildfires.", out.width='97%', out.height='97%', echo=TRUE, warning=FALSE}
